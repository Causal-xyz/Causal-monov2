        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="0.00"
              className="flex-1 rounded-lg border border-border bg-background px-3 py-2 text-sm outline-none transition-colors focus:border-causal/50 focus:ring-1 focus:ring-causal/30"
            />
            <Button
              variant="outline"
              size="sm"
